...
extern rule_t const rules_tb[NSINT];
...
extern input_t const inputs_tb[NVXOD];

/* Adjacency matrix which will become reachability matrix afterward */
extern bool_t adj_reach_mtrx[NVXOD][NNETRM];

/* Function finds necessary string with sought-for symbol in the 'inputs_tb'-table 
 * and returns string-index of inputs_tb-table.
 * 
